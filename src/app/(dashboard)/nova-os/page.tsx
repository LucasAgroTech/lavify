...
export default function NovaOSPage() {
  ...
  return (
    <>
      {/* ==================== MOBILE VERSION ==================== */}
      <div className="lg:hidden min-h-screen bg-slate-50 pb-32">
        {/* Header */}
        ...
        {/* Floating Summary */}
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-4 safe-area-pb z-30 lg:hidden">
        ...
        {showClienteList && (
          <div className="fixed inset-0 bg-black/50 z-50 lg:hidden">
            <div className="absolute inset-x-0 bottom-0 bg-white rounded-t-3xl max-h-[85vh] flex flex-col animate-slide-in">
              <div className="p-4 border-b border-slate-100">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="font-bold text-lg text-slate-800">Buscar Cliente</h2>
                  <button onClick={() => setShowClienteList(false)} className="p-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-slate-100 rounded-xl text-slate-800 placeholder:text-slate-400"
                    autoFocus
                  />
                </div>
              </div>
              ...
              <div className="p-4 border-t border-slate-100 safe-area-pb">
                <button
                  ...
                  className="w-full py-3 bg-cyan-500 text-white font-semibold rounded-xl flex items-center justify-center gap-2"
                >
                  <Plus className="w-5 h-5" />
